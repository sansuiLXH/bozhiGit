...
/**
 * @author 西西里_SanSui
 * @date Created in 2021/5/12 23:38
 * @modified By  西西里_SanSui in 2021/5/12 23:38
 * @description AddDescriptionHere
 */
public class RedisUpdate extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String temp2 = req.getParameter("avgscore");

        if (temp2 != null && !temp2 .equals("")) {
            avgscore  = Double.parseDouble(temp2);
        }
